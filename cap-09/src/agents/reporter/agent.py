# src/agents/reporter/agent.py - versao cap-06 (sem alteracoes caps 07-09)
import asyncio
import os
...
MCP_SERVER_CONFIG = {"report": {"url": os.getenv("REPORT_MCP_URL", "http://localhost:8003/mcp"), "transport": "http"}}
